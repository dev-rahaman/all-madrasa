      ...
      <div className="flex flex-wrap  gap-2 ms-5 mb-5 mt-14">
        <div className="shadow-md w-[230px] h-[350px]   ">
          ...
          <div className="p-2">
            ...
            <div className="flex justify-between items-center">
              ...
              <a href="/feed/book/1" className="text-white p-1 bg-green-500">
                Details
              </a>
            </div>
          </div>
        ...
        <div className="shadow-md w-[230px] h-[350px]   ">
          ...
          <div className="p-2">
            ...
            <div className="flex justify-between items-center">
              <span className="text-green-500 font-semibold">$19.99</span>
              <a href="/feed/book/2" className="text-white p-1 bg-green-500">
                Details
              </a>
            </div>
          </div>
        ...
        <div className="shadow-md w-[230px] h-[350px]   ">
          ...
          <div className="p-2">
            ...
            <div className="flex justify-between items-center">
              <span className="text-green-500 font-semibold">$19.99</span>
              <a href="/feed/book/3" className="text-white p-1 bg-green-500">
                Details
              </a>
            </div>
          </div>
