  ...
  return (
    <div>
      <div className="bg-gray-200 p-5 rounded lg:w-[350px]">
        <h2 className="text-xl font-bold text-[#ea8b26]">Find a Blog</h2>
        <div className="flex ">
          <input
            type="text"
            id="title"
...
export const ResentBlog = () => {
  return (
    <div className="lg:w-[350px] space-y-2 p-5 mt-3 bg-gray-50 rounded border">
      <h2 className="text-xl font-bold text-[#ea8b26]">Resent Blogs</h2>
      <Link
        href={"#"}
...
export const BlogsCategory = () => {
  return (
    <div className="lg:w-[350px] space-y-2 p-5 mt-3 bg-gray-50 rounded border">
      <h2 className="text-xl font-bold text-[#ea8b26]">Blogs Category</h2>
...
export const BlogsTags = () => {
  return (
    <div className="lg:w-[350px] space-y-2 p-5 mt-3 bg-gray-50 rounded border">
      <h2 className="text-xl font-bold text-[#ea8b26]">Blogs Tags</h2>
