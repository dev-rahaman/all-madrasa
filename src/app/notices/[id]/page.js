  ...
  return (
    <div className="lg:w-[500px]">
      ...
      <div>
        ...
        <p className="my-5">
          ডেটাবেস সেটআপ: নিশ্চিত করুন যে আপনার কাছে MongoDB সেট আপ আছে এবং আপনার
          পোস্টগুলি সংরক্ষণ করার জন্য একটি সংগ্রহ রয়েছে৷ আপনার যদি এখনও না থাকে
          তবে আপনি MongoDB এর শেল বা MongoDB কম্পাসের মতো একটি টুল ব্যবহার করে
          এটি তৈরি করতে পারেন।
        </p>
        <p>
          পোস্টের জন্য স্কিমা: আপনার পোস্টের জন্য একটি স্কিমা নির্ধারণ করুন।
          MongoDB-তে, এটি নমনীয় হতে পারে, তবে আপনি Mongoose (একটি MongoDB ORM)
          ব্যবহার করে একটি Node.js অ্যাপ্লিকেশনে এর মতো একটি মৌলিক কাঠামো
