  ...
  return (
    <div className="m-10">
      <Image
        ...
        height={150}
      ></Image>
      <h2 className="text-4xl font-bold mt-5">জামিয়া রশীদিয়া ফেনী</h2>
      <div className="flex items-center gap-5">
        <h4 lassName="text-4xl font-bold mt-5">স্থাপিত: ১৯৯৬</h4>
        <h4 lassName="text-4xl font-bold mt-5">রেজিস্ট্রেশন নম্বর: ১৯৯৬</h4>
        <div className="flex">
          <svg
          ...
          <h4 lassName="text-4xl font-bold mt-5"> ফেনী</h4>
        </div>
      </div>
    </div>
  );
