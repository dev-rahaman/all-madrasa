...
const Porik = () => {
  return (
    <div className="flex items-center justify-center  flex-wrap gap-5 my-20">
      <div className="m-5 bg-[url('/dini-ilm.jpg')] bg-center bg-cover flex items-center justify-center flex-col max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
